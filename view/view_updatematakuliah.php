            ...
            <div class="card-body">
                ...
                <form action="../controller/controller_matakuliah.php" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="inputNamaMK" class="form-control" value="<?=htmlspecialchars($mk->getNamaMk())?>" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Kode</label>
                        <input type="text" name="inputKode" class="form-control" value="<?=htmlspecialchars($mk->getKode())?>" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">SKS</label>
                        <input type="number" name="inputSks" class="form-control" value="<?=htmlspecialchars($mk->getSks())?>" min="1" max="6" required>
                    </div>
